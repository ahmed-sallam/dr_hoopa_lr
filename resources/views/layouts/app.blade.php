...
<body
    class="font-sans antialiased {{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }} bg-white dark:bg-black text-black dark:text-white">
    <div class="min-h-screen ">


        <nav class="bg-white dark:bg-black fixed w-full z-20 top-0 start-0   md:pl-32">
            <div class="max-w-screen-2xl flex  items-center justify-between mx-auto p-4 flex-wrap">
                ...
                <div class="flex items-center justify-center gap-2">
                    <h2>{{ $title ?? '' }}</h2>
                    @if (isset($logo))
                        <img src="{{ asset($logo) }}" class="w-10 h-10" alt="{{ $title }}" />
                    @endif
                </div>
            </div>
        </nav>
        ...
        <aside id="default-sidebar"
            ...
            aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 lg:rounded-3xl">
                <ul class="space-y-2 font-medium">
                    ...
                    <li class="flex items-center justify-center ">
                        <a href="{{ route('course.index') }}" wire:navigate
                            ...
                            <img src="{{ asset('images/courses.png') }}" class="w-8 h-8" />
                            <p>الكورسات</p>
                        </a>
                    </li>
                </ul>
